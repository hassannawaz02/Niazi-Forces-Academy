...
import Commission from "./CommissonSection";
  ...
  return (
    ...
    <section className=" py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-4xl font-extrabold text-teal-300 mb-3">Our Featured Courses</h2>
        ...
        <div className="mt-12 text-center">
          <p className="text-green-700 text-lg font-semibold">
            ...
            <a href="/contact" className="underline hover:text-green-900 transition">
              Contact Us
            </a>{' '}
            at <span>0314-4220065</span>
          </p>
        </div>
      </div>
    </section>
